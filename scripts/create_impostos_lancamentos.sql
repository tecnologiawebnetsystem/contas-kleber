...
-- Armazena os tipos configuráveis (IRPJ, CSLL, COFINS, PIS para PJ e INSS, IRRF, Plano de Saúde, etc. para CLT)
...
-- Vincula um lançamento mensal a uma consultoria
...
-- Armazena cada imposto/desconto aplicado no lançamento mensal
...
-- Inserir impostos padrão PJ (IRPJ, CSLL, COFINS, PIS)
...
-- Inserir descontos padrão CLT (INSS, IRRF, Plano de Saúde, VR/VA)
INSERT INTO impostos_descontos (id, nome, tipo_aplicacao, tipo_calculo, valor_padrao, descricao) VALUES
